...
const ConfirmCut = ({onConfirmCutOrder, order, cancelFunc }) => {
  ...
  return <>
    <div className="grid md:grid-cols-2 gap-y-8 justify-between items-center">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-self-center md:justify-self-end">
        ...
        <Button className={"bg-red-600 hover:bg-red-800"} onClick={cancelFunc ? cancelFunc : () => navigate("/orders")}>Cancelar corte</Button>
      </div>
    </div>
