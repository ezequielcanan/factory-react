...
const ArticleCard = ({article}) => {
  ...
  return (
    <motion.div onClick={() => navigate(`/articles/${article?._id}`)} initial={{height: 0, opacity: 0}} transition={{duration: 0.5}} animate={{height: "auto", opacity: 1}} className="flex flex-col text-white cursor-pointer hover:bg-primary duration-300 rounded-lg bg-secondary justify-items-center overflow-hidden">
